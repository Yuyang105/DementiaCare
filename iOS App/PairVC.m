...
- (void)changeSwitch:(UISwitch *)sender{
    if ([sender isOn]) {
        NSString *post = [[NSString alloc] initWithFormat:@"user=%@&email=%@&agree=%@",[[NSUserDefaults standardUserDefaults] stringForKey:@"email"], _arrRequest[sender.tag], @"agree"];
        NSLog(@"PostData: %@", post);
...
//    else {
//        NSString *post = [[NSString alloc] initWithFormat:@"user=%@&email=%@&remove=%@",[[NSUserDefaults standardUserDefaults] stringForKey:@"email"], _arrRequest[sender.tag], @"remove"];
//        NSLog(@"PostData: %@", post);
//        NSURL *url = [NSURL URLWithString:@"http://www.cloudcampus.xyz/DementiaCare/fetch.php"];
//        NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding allowLossyConversion:YES];
//        NSString *postLength = [NSString stringWithFormat:@"%lu", (unsigned long)[postData length]];
